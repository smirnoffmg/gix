...
impl CommentGenerator {
    ...
    fn initialize_comments(&mut self) {
        ...
        self.pattern_comments
            .insert("*.pyc".to_string(), "Python bytecode files".to_string());
        self.pattern_comments.insert(
            "__pycache__/".to_string(),
            "Python cache directory".to_string(),
        );
        self.pattern_comments.insert(
            "*.pyo".to_string(),
            "Python optimized bytecode files".to_string(),
        );
        self.pattern_comments
            .insert("*.pyd".to_string(), "Python dynamic modules".to_string());
        self.pattern_comments
            .insert("*.so".to_string(), "Shared object files".to_string());
        self.pattern_comments
            .insert("*.egg".to_string(), "Python egg packages".to_string());
        self.pattern_comments
            .insert("*.egg-info/".to_string(), "Python egg metadata".to_string());
        self.pattern_comments.insert(
            "dist/".to_string(),
            "Distribution/packaging directory".to_string(),
        );
        self.pattern_comments
            .insert("build/".to_string(), "Build output directory".to_string());
        self.pattern_comments.insert(
            "venv/".to_string(),
            "Python virtual environment".to_string(),
        );
        self.pattern_comments
            .insert("env/".to_string(), "Python virtual environment".to_string());
        self.pattern_comments
            .insert(".env".to_string(), "Environment variables file".to_string());
        self.pattern_comments
            .insert(".coverage".to_string(), "Python coverage data".to_string());
        self.pattern_comments.insert(
            ".pytest_cache/".to_string(),
            "Pytest cache directory".to_string(),
        );

        // Node.js pattern comments
        self.pattern_comments.insert(
            "node_modules/".to_string(),
            "Node.js dependencies".to_string(),
        );
        self.pattern_comments
            .insert("npm-debug.log*".to_string(), "NPM debug logs".to_string());
        self.pattern_comments
            .insert("yarn-debug.log*".to_string(), "Yarn debug logs".to_string());
        self.pattern_comments
            .insert("yarn-error.log*".to_string(), "Yarn error logs".to_string());
        self.pattern_comments
            .insert("coverage/".to_string(), "Test coverage reports".to_string());
        self.pattern_comments
            .insert(".nyc_output".to_string(), "NYC coverage output".to_string());
        self.pattern_comments
            .insert(".next/".to_string(), "Next.js build output".to_string());
        self.pattern_comments
            .insert("out/".to_string(), "Build output directory".to_string());

        // Java pattern comments
        self.pattern_comments
            .insert("*.class".to_string(), "Java compiled classes".to_string());
        self.pattern_comments
            .insert("*.jar".to_string(), "Java archive files".to_string());
        self.pattern_comments
            .insert("*.war".to_string(), "Web application archive".to_string());
        self.pattern_comments
            .insert("target/".to_string(), "Maven build output".to_string());
        self.pattern_comments
            .insert(".gradle/".to_string(), "Gradle cache directory".to_string());

        // Rust pattern comments
        self.pattern_comments
            .insert("Cargo.lock".to_string(), "Cargo lock file".to_string());
        self.pattern_comments
            .insert("target/".to_string(), "Rust build output".to_string());
        self.pattern_comments
            .insert("*.pdb".to_string(), "Program database files".to_string());
        self.pattern_comments
            .insert("*.exe".to_string(), "Executable files".to_string());
        self.pattern_comments
            .insert("*.dll".to_string(), "Dynamic link libraries".to_string());
        self.pattern_comments
            .insert("*.so".to_string(), "Shared object files".to_string());
        self.pattern_comments.insert(
            "*.dylib".to_string(),
            "Dynamic libraries (macOS)".to_string(),
        );

        // IDE pattern comments
        self.pattern_comments.insert(
            ".vscode/".to_string(),
            "VSCode workspace settings".to_string(),
        );
        self.pattern_comments
            .insert(".idea/".to_string(), "IntelliJ IDEA settings".to_string());
        self.pattern_comments
            .insert("*.swp".to_string(), "Vim swap files".to_string());
        self.pattern_comments
            .insert("*.swo".to_string(), "Vim swap files".to_string());
        self.pattern_comments
            .insert("*~".to_string(), "Backup files".to_string());

        // OS pattern comments
        self.pattern_comments
            .insert(".DS_Store".to_string(), "macOS system files".to_string());
        self.pattern_comments.insert(
            "Thumbs.db".to_string(),
        ...
        self.pattern_comments.insert(
            ...
            "Windows desktop configuration".to_string(),
        );

        // Common pattern comments
        self.pattern_comments
            .insert("*.log".to_string(), "Log files".to_string());
        self.pattern_comments
            .insert("*.tmp".to_string(), "Temporary files".to_string());
        self.pattern_comments
            .insert("*.temp".to_string(), "Temporary files".to_string());
        self.pattern_comments
            .insert("*.bak".to_string(), "Backup files".to_string());
        self.pattern_comments
            .insert("*.cache".to_string(), "Cache files".to_string());
        self.pattern_comments
            .insert("*.pid".to_string(), "Process ID files".to_string());
        self.pattern_comments
            .insert("*.lock".to_string(), "Lock files".to_string());
    ...
    pub fn generate_pattern_comment(
        &self,
        pattern: &str,
    ...
    pub fn generate_pattern_comments(
        &self,
        patterns: &[String],
    ...
    pub fn generate_detailed_comment(
        &self,
        pattern: &str,
        analysis: &PatternAnalysis,
...
mod tests {
    ...
    fn test_generate_section_header() {
        let generator = CommentGenerator::new();
        let header =
            generator.generate_section_header(&PatternCategory::Language("Python".to_string()));
    ...
    fn test_generate_category_comment() {
        let generator = CommentGenerator::new();
        let comment =
            generator.generate_category_comment(&PatternCategory::Language("Python".to_string()));
